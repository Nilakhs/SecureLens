...
function App() {
  const [currentTab, setCurrentTab] = useState("scan"); // "scan" | "history"
  ...
  const handleHistoricalScanSelect = (data) => {
    setScanResult(data);
    setActiveView("grouped");
    setCurrentTab("scan");
    setTimeout(() => {
  ...
  return (
    <div className="app-wrapper">
      ...
      <header className="app-header">
        <div className="header-content">
          ...
          <nav className="header-nav" aria-label="Main Navigation">
            <button
              className={`nav-link ${currentTab === "scan" ? "active" : ""}`}
      ...
      <main className="app-main">
        ...
        {currentTab === "history" && (
          <HistoryDashboard onScanSelect={handleHistoricalScanSelect} />
        )}
      </main>
